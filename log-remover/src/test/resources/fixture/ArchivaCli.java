...
public class ArchivaCli {
    ...
    public ArchivaCli() {
        applicationContext = new ClassPathXmlApplicationContext(new String[] { "classpath*:/META-INF/spring-context.xml" });
    }
    ...
    private List<KnownRepositoryContentConsumer> getConsumerList(String[] consumers) throws ConsumerException {
    ...
    private Map<String, KnownRepositoryContentConsumer> getConsumers() {
        Map<String, KnownRepositoryContentConsumer> beans = applicationContext.getBeansOfType(KnownRepositoryContentConsumer.class);
    ...
    private void doConversion(String properties) throws IOException, RepositoryConversionException {
