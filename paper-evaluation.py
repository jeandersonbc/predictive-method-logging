...
# Executable script exported and adapted from Jupyter notebook.
...
# Stores estimators and feature importance across experiments
ESTIMATORS = {}
FEATURE_IMPORTANCES = {}
...
print(results_rq1["prec recall acc tn fp fn tp total".split(" ")])
...
print(results_rq2[relevant_cols])
